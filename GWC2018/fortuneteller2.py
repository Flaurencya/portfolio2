...
def evennumberchoice():
    return input("Choose a number from 3,4,7, or 8")
def choice1():
...
def fortune(color2):
    if (color2 == "green") or (color2 == "brown"):
        odd = oddnumberchoice()
        if odd == "1":
            choice1()
        if odd == "2":
        ...
        if odd == "6":
            choice6()
    elif (color2 == "purple") or (color2 == "blue"):
...
def main():
    color = input("Choose a color from green, blue, purple, brown?")
    fortune(color)
